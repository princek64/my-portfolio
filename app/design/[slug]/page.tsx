...
import { getDesignCaseStudies } from "app/lib/case-studies";

export async function generateStaticParams() {
  return getDesignCaseStudies().map((s) => ({ slug: s.slug }));
}
...
export async function generateMetadata({
  ...
  const study = getDesignCaseStudies().find((s) => s.slug === params.slug);
  if (!study) return;
  return {
